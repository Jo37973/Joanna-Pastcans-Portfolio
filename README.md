...
* My motivation is to create a portfolio of my work that can be used to showcase my skills and knowledge to potential employters to attain a full-time or part-time position as a web-developer. 
...
* These are the acceptance criteria followed: 
...
# Usage 
* This site and code will be used as my Portfolio page.
